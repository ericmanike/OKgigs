    ...
    <div className="min-h-screen bg-linear-to-b from-zinc-50 to-white pt-24 md:pt-28 pb-12 px-4">
      <div className="max-w-lg mx-auto">
        <div className="rounded-2xl bg-white border border-slate-200/80 shadow-lg shadow-slate-200/50 overflow-hidden">
          <div className="bg-[#E42320] px-5 py-6 text-center">
          ...
          <div className="p-5 md:p-6 space-y-3">
            <Link
              href="/track-order"
              className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#E42320] text-white font-medium hover:bg-[#E42320]/90 transition-colors"
            >
